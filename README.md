These files are all exercises as laid out by The Odin Project. Normally, I would not have pushed this to my GitHub, but the project description said to push it to GitHub 
when we completed it. That being said, here it is. The entire project is all in Ruby, and the HTML files were provided by The Odin Project to serve as hints if needed.
The project can be found here: https://www.theodinproject.com/courses/web-development-101/lessons/ruby
